...
public class CheckBox extends android.widget.CheckBox {
    public CheckBox(Context context0) {
        super(context0);
    }

    public CheckBox(Context context0, AttributeSet attributeSet0) {
        super(context0, attributeSet0);
    }

    public CheckBox(Context context0, AttributeSet attributeSet0, int v) {
        super(context0, attributeSet0, v);
    }

    public CheckBox(Context context0, AttributeSet attributeSet0, int v, int v1) {
