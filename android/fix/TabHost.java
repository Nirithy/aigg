...
public class TabHost extends android.widget.TabHost {
    public TabHost(Context context0) {
        super(context0);
    }

    public TabHost(Context context0, AttributeSet attributeSet0) {
        super(context0, attributeSet0);
    }

    public TabHost(Context context0, AttributeSet attributeSet0, int v) {
        super(context0, attributeSet0, v);
    }

    public TabHost(Context context0, AttributeSet attributeSet0, int v, int v1) {
